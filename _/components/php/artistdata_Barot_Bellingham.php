<article id ="Barot_Bellingham" class="media">
	...
	<img class="pull-left img-rounded"src="images/artists/Barot_Bellingham_tn.jpg" alt="Photo of Barot Bellingham">
		<div class="media-body">
			...
			<section class="modalphotos photogrid">
				<h3>Artwork</h3>
				<img src="images/artwork/Barot_Bellingham_01_tn.jpg" alt="">
				<img src="images/artwork/Barot_Bellingham_02_tn.jpg" alt="">
				<img src="images/artwork/Barot_Bellingham_03_tn.jpg" alt="">
			</section><!--modalphotos-->
		</div><!--Media Body-->
