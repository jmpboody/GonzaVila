	...
	<img class="pull-left img-rounded"src="images/artists/Constance_Smith_tn.jpg" alt="Photo of Constance Smith">
		<div class="media-body">
			...
			<section class="modalphotos photogrid">
				...
				<img src="images/artwork/Constance_Smith_04_tn.jpg" alt="Art from Constance Smith">
				<img src="images/artwork/Constance_Smith_05_tn.jpg" alt="Art from Constance Smith">
			</section><!--modalphotos-->
		</div><!--Media Body-->
