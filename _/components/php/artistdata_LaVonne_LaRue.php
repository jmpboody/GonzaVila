<article id="LaVonne_LaRue" class="media">
	...
	<div class="media-body">
		...
		<section class="modalphotos photogrid">
			...
			<img src="images/artwork/LaVonne_LaRue_02_tn.jpg" alt="Art from LaVonne LaRue">
			<img src="images/artwork/LaVonne_LaRue_03_tn.jpg" alt="Art from LaVonne LaRue">
			<img src="images/artwork/LaVonne_LaRue_04_tn.jpg" alt="Art from LaVonne LaRue">
			<img src="images/artwork/LaVonne_LaRue_05_tn.jpg" alt="Art from LaVonne LaRue">
			</section><!--modalphotos-->
		</div><!--Media Body-->
